        ...
        <div className="flex flex-col lg:flex-row items-start gap-12">
          ...
          <div className="lg:w-7/12 mt-12 lg:mt-0 text-left">
            ...
            <div className="mt-10">
              <Link
                href="/contact"
                className="inline-flex items-center px-6 py-3 rounded-lg bg-blue-600 text-white font-medium shadow-md hover:bg-blue-700 transition-colors duration-300"
              >
                Get In Touch
              </Link>
            </div>
  ...
  return (
    <div className="flex flex-col p-4 bg-gray-700 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
      <div className="flex items-center gap-4 mb-3">
        <div className="bg-blue-900 p-3 rounded-full text-blue-400 flex-shrink-0">
          {icon}
        </div>
